#ifndef CAFFE_EUCLIDEAN_SHOW_LOSS_LAYER_HPP_
#define CAFFE_EUCLIDEAN_SHOW_LOSS_LAYER_HPP_
...
class EuclideanShowLossLayer : public LossLayer<Dtype> {
 public:
  explicit EuclideanShowLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "EuclideanShowLoss"; }
  /**
 ...
 protected:
  /// @copydoc EuclideanShowLossLayer
...
#endif  // CAFFE_EUCLIDEAN_SHOW_LOSS_LAYER_HPP_
